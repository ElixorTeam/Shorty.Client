...
export default function AppPage() {
  return (
    <div className="h-full w-full grid-cols-[18rem,1fr] grid-rows-1 divide-x border-x dark:divide-white/[.2] dark:border-x-white/[.2] sm:grid">
      ...
      <div className="relative hidden w-full overflow-clip sm:flex sm:flex-col">
        ...
        <div className="flex h-full w-full flex-col-reverse lg:grid lg:flex-none lg:grid-cols-[1fr,18rem] lg:grid-rows-1 lg:divide-x lg:bg-slate-50 lg:dark:divide-white/[.2] lg:dark:bg-neutral-900">
          <Dashboard />
