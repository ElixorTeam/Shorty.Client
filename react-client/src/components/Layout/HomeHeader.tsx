...
export default function HomeHeader() {
  return (
    <header className="fixed top-0 z-40 flex h-14 w-full shrink-0 items-center border-b bg-white/[.5] px-10 backdrop-blur-md dark:border-b-white/[.15] dark:bg-black/[.3]">
