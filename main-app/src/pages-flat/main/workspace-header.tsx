...
export default async function WorkspaceHeader({
  ...
  return (
    <div className="sticky top-0 z-20 grid h-14 w-full shrink-0 grid-cols-5 gap-4 border-b bg-background/[.95] px-6 backdrop-blur supports-[backdrop-filter]:bg-background/[.6]">
      ...
      <div className="col-span-3 flex items-center justify-center gap-2">
        {isAnySelectedLink && (
          <>
            ...
            <div className="flex h-10 items-center overflow-hidden rounded-md bg-muted px-4 shadow-sm">
